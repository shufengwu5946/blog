...
回到webpack-base-demo文件夹，并在里面创建app文件夹app文件夹用来存放原始数据和我们将写的JavaScript模块，接下来我们在app文件夹中创建三个文件:
...
我们在index.tmpl.html文件中写入最基础的html代码。
```html
<!-- index.tmpl.html -->
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div id="div1" class="div1">测试1222</div>
</body>
</html>
```
